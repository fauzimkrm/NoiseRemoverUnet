...
parser.add_argument('--datadir', '-dd', type=str, default='data', help='データ画像ディレクトリ')
parser.add_argument('--labeldir', '-ld', type=str, default='label', help='ラベル画像ディレクトリ')
parser.add_argument('--in_validir', '-ivd', type=str, default='training_data/in_vali', help='in_vali画像ディレクトリ')
parser.add_argument('--in_traindir', '-itd', type=str, default='training_data/in_train', help='in_train画像ディレクトリ')
parser.add_argument('--out_validir', '-ovd', type=str, default='training_data/out_vali', help='out_vali画像ディレクトリ')
parser.add_argument('--out_traindir', '-otd', type=str, default='training_data/out_train', help='out_train画像ディレクトリ')
